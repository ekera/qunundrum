...
/*!
 * \defgroup unit_tests_keccak_random \
...
#ifndef TEST_KECCAK_RANDOM_H
#define TEST_KECCAK_RANDOM_H

/*!
 * \brief   Executes all unit tests for the \ref keccak_random module.
 */
void test_keccak_random();

#endif /* TEST_KECCAK_RANDOM_H */
