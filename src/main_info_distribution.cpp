/*!
 * \file    main_info_distribution.cpp
 * \ingroup info_distribution_exe
 *
 * \brief   The definition of the main entry point to the info_distribution
 *          executable, and of associated functions.
 */

/*!
 * \defgroup info_distribution_exe \
 *           The info_distribution executable
 * \ingroup  manipulate_executable
 *
 * \brief    A module for the info_distribution executable.
 */
...
static void print_synopsis(
  FILE * const file)
{
  fprintf(file, "Synopsis: info_distribution <distribution>\n");
}

/*!
 * \brief The main entry point to the info_distribution executable.
 *
