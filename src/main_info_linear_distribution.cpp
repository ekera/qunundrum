/*!
 * \file    main_info_linear_distribution.cpp
 * \ingroup info_linear_distribution_exe
 *
 * \brief   The definition of the main entry point to the
 *          info_linear_distribution executable, and of associated functions.
 */

/*!
 * \defgroup info_linear_distribution_exe \
 *           The info_linear_distribution executable
...
static void print_synopsis(
  FILE * const file)
{
  fprintf(file, "Synopsis: info_linear_distribution <distribution>\n");
}

/*!
 * \brief The main entry point to the info_linear_distribution executable.
 *
